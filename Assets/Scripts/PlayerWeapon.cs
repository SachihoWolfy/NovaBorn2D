...
public class PlayerWeapon : MonoBehaviour
{
    ...
    public void TryShoot()
    {
        ...
        if ((curAmmo <= 0 || Time.time - lastShootTime < shootRate) && !fpActive)
        {
            ...
            SoundController.instance.PlaySound(AS, Fail);
            return;
        }
        ...
        else
        {
            ...
            player.photonView.RPC("SpawnBullet", RpcTarget.All, bulletSpawnPos.transform.position, player.gun.transform.up);
    ...
    public void GiveAmmo(int ammoToGive)
    {
        ...
        GameUI.instance.UpdateAmmoText();
        GameUI.instance.UpdateFPAmmo();
        SoundController.instance.PlaySound(AS, PowerGet);
    }
